...
START_EXTERN_C
uint8 FASTCALL S9xSA1GetByte (uint32, struct SCPUState *);
uint16 FASTCALL S9xSA1GetWord (uint32, struct SCPUState *);
void FASTCALL S9xSA1SetByte (uint8, uint32, struct SCPUState *);
void FASTCALL S9xSA1SetWord (uint16, uint32, struct SCPUState *);
void FASTCALL S9xSA1SetPCBase (uint32, struct SCPUState *);
