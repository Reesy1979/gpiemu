...
static void fx_umult_i7(struct FxRegs_s * gsu) { FX_UMULT_I(7); }
static void fx_umult_i8(struct FxRegs_s * gsu) { FX_UMULT_I(8); }
static void fx_umult_i9(struct FxRegs_s * gsu) { FX_UMULT_I(9); }
static void fx_umult_i10(struct FxRegs_s * gsu) { FX_UMULT_I(10); }
static void fx_umult_i11(struct FxRegs_s * gsu) { FX_UMULT_I(11); }
static void fx_umult_i12(struct FxRegs_s * gsu) { FX_UMULT_I(12); }
static void fx_umult_i13(struct FxRegs_s * gsu) { FX_UMULT_I(13); }
static void fx_umult_i14(struct FxRegs_s * gsu) { FX_UMULT_I(14); }
static void fx_umult_i15(struct FxRegs_s * gsu) { FX_UMULT_I(15); }
  
/* 90 - sbk - store word to last accessed RAM address */
static void fx_sbk(struct FxRegs_s * gsu)
{
...
static void fx_link_i1(struct FxRegs_s * gsu) { FX_LINK_I(1); }
static void fx_link_i2(struct FxRegs_s * gsu) { FX_LINK_I(2); }
static void fx_link_i3(struct FxRegs_s * gsu) { FX_LINK_I(3); }
static void fx_link_i4(struct FxRegs_s * gsu) { FX_LINK_I(4); }

/* 95 - sex - sign extend 8 bit to 16 bit */
static void fx_sex(struct FxRegs_s * gsu)
{
...
static void fx_asr(struct FxRegs_s * gsu)
{
    uint32 v;
    gsu->vCarry = SREG & 1;
...
static void fx_div2(struct FxRegs_s * gsu)
{
    uint32 v;
    int32 s = SEX16(SREG);
    gsu->vCarry = s & 1;
...
static void fx_ror(struct FxRegs_s * gsu)
{
...
R15 = gsu->avReg[reg]; \
CLRFLAGS;
static void fx_jmp_r8(struct FxRegs_s * gsu) { FX_JMP(8); }
static void fx_jmp_r9(struct FxRegs_s * gsu) { FX_JMP(9); }
static void fx_jmp_r10(struct FxRegs_s * gsu) { FX_JMP(10); }
static void fx_jmp_r11(struct FxRegs_s * gsu) { FX_JMP(11); }
static void fx_jmp_r12(struct FxRegs_s * gsu) { FX_JMP(12); }
static void fx_jmp_r13(struct FxRegs_s * gsu) { FX_JMP(13); }
...
R15 = SREG; \
gsu->bCacheActive = FALSE; fx_cache(gsu); R15--;
static void fx_ljmp_r8(struct FxRegs_s * gsu) { FX_LJMP(8); }
static void fx_ljmp_r9(struct FxRegs_s * gsu) { FX_LJMP(9); }
static void fx_ljmp_r10(struct FxRegs_s * gsu) { FX_LJMP(10); }
static void fx_ljmp_r11(struct FxRegs_s * gsu) { FX_LJMP(11); }
static void fx_ljmp_r12(struct FxRegs_s * gsu) { FX_LJMP(12); }
static void fx_ljmp_r13(struct FxRegs_s * gsu) { FX_LJMP(13); }

/* 9e - lob - set upper byte to zero (keep low byte) */
static void fx_lob(struct FxRegs_s * gsu)
{
    uint32 v = USEX8(SREG);
    R15++; DREG = v;
    gsu->vSign = v<<8;
...
static void fx_fmult(struct FxRegs_s * gsu)
{
    uint32 v;
...
static void fx_lmult(struct FxRegs_s * gsu)
{
    uint32 v;
    uint32 c = (uint32) (SEX16(SREG) * SEX16(R6));
    R4 = c;
...
CLRFLAGS;
static void fx_ibt_r0(struct FxRegs_s * gsu) { FX_IBT(0); }
static void fx_ibt_r1(struct FxRegs_s * gsu) { FX_IBT(1); }
static void fx_ibt_r2(struct FxRegs_s * gsu) { FX_IBT(2); }
static void fx_ibt_r3(struct FxRegs_s * gsu) { FX_IBT(3); }
static void fx_ibt_r4(struct FxRegs_s * gsu) { FX_IBT(4); }
static void fx_ibt_r5(struct FxRegs_s * gsu) { FX_IBT(5); }
static void fx_ibt_r6(struct FxRegs_s * gsu) { FX_IBT(6); }
static void fx_ibt_r7(struct FxRegs_s * gsu) { FX_IBT(7); }
static void fx_ibt_r8(struct FxRegs_s * gsu) { FX_IBT(8); }
static void fx_ibt_r9(struct FxRegs_s * gsu) { FX_IBT(9); }
static void fx_ibt_r10(struct FxRegs_s * gsu) { FX_IBT(10); }
static void fx_ibt_r11(struct FxRegs_s * gsu) { FX_IBT(11); }
static void fx_ibt_r12(struct FxRegs_s * gsu) { FX_IBT(12); }
static void fx_ibt_r13(struct FxRegs_s * gsu) { FX_IBT(13); }
static void fx_ibt_r14(struct FxRegs_s * gsu) { FX_IBT(14); READR14; }
static void fx_ibt_r15(struct FxRegs_s * gsu) { FX_IBT(15); }
...
CLRFLAGS;
static void fx_lms_r0(struct FxRegs_s * gsu) { FX_LMS(0); }
static void fx_lms_r1(struct FxRegs_s * gsu) { FX_LMS(1); }
static void fx_lms_r2(struct FxRegs_s * gsu) { FX_LMS(2); }
static void fx_lms_r3(struct FxRegs_s * gsu) { FX_LMS(3); }
static void fx_lms_r4(struct FxRegs_s * gsu) { FX_LMS(4); }
static void fx_lms_r5(struct FxRegs_s * gsu) { FX_LMS(5); }
static void fx_lms_r6(struct FxRegs_s * gsu) { FX_LMS(6); }
static void fx_lms_r7(struct FxRegs_s * gsu) { FX_LMS(7); }
static void fx_lms_r8(struct FxRegs_s * gsu) { FX_LMS(8); }
static void fx_lms_r9(struct FxRegs_s * gsu) { FX_LMS(9); }
static void fx_lms_r10(struct FxRegs_s * gsu) { FX_LMS(10); }
static void fx_lms_r11(struct FxRegs_s * gsu) { FX_LMS(11); }
static void fx_lms_r12(struct FxRegs_s * gsu) { FX_LMS(12); }
static void fx_lms_r13(struct FxRegs_s * gsu) { FX_LMS(13); }
static void fx_lms_r14(struct FxRegs_s * gsu) { FX_LMS(14); READR14; }
static void fx_lms_r15(struct FxRegs_s * gsu) { FX_LMS(15); }
...
CLRFLAGS; R15++;
static void fx_sms_r0(struct FxRegs_s * gsu) { FX_SMS(0); }
static void fx_sms_r1(struct FxRegs_s * gsu) { FX_SMS(1); }
static void fx_sms_r2(struct FxRegs_s * gsu) { FX_SMS(2); }
static void fx_sms_r3(struct FxRegs_s * gsu) { FX_SMS(3); }
static void fx_sms_r4(struct FxRegs_s * gsu) { FX_SMS(4); }
static void fx_sms_r5(struct FxRegs_s * gsu) { FX_SMS(5); }
static void fx_sms_r6(struct FxRegs_s * gsu) { FX_SMS(6); }
static void fx_sms_r7(struct FxRegs_s * gsu) { FX_SMS(7); }
static void fx_sms_r8(struct FxRegs_s * gsu) { FX_SMS(8); }
static void fx_sms_r9(struct FxRegs_s * gsu) { FX_SMS(9); }
static void fx_sms_r10(struct FxRegs_s * gsu) { FX_SMS(10); }
static void fx_sms_r11(struct FxRegs_s * gsu) { FX_SMS(11); }
static void fx_sms_r12(struct FxRegs_s * gsu) { FX_SMS(12); }
static void fx_sms_r13(struct FxRegs_s * gsu) { FX_SMS(13); }
static void fx_sms_r14(struct FxRegs_s * gsu) { FX_SMS(14); }
static void fx_sms_r15(struct FxRegs_s * gsu) { FX_SMS(15); }
...
static void fx_from_r0(struct FxRegs_s * gsu) { FX_FROM(0); }
static void fx_from_r1(struct FxRegs_s * gsu) { FX_FROM(1); }
static void fx_from_r2(struct FxRegs_s * gsu) { FX_FROM(2); }
static void fx_from_r3(struct FxRegs_s * gsu) { FX_FROM(3); }
static void fx_from_r4(struct FxRegs_s * gsu) { FX_FROM(4); }
static void fx_from_r5(struct FxRegs_s * gsu) { FX_FROM(5); }
static void fx_from_r6(struct FxRegs_s * gsu) { FX_FROM(6); }
static void fx_from_r7(struct FxRegs_s * gsu) { FX_FROM(7); }
static void fx_from_r8(struct FxRegs_s * gsu) { FX_FROM(8); }
static void fx_from_r9(struct FxRegs_s * gsu) { FX_FROM(9); }
static void fx_from_r10(struct FxRegs_s * gsu) { FX_FROM(10); }
static void fx_from_r11(struct FxRegs_s * gsu) { FX_FROM(11); }
static void fx_from_r12(struct FxRegs_s * gsu) { FX_FROM(12); }
static void fx_from_r13(struct FxRegs_s * gsu) { FX_FROM(13); }
static void fx_from_r14(struct FxRegs_s * gsu) { FX_FROM(14); }
static void fx_from_r15(struct FxRegs_s * gsu) { FX_FROM(15); }

/* c0 - hib - move high-byte to low-byte */
static void fx_hib(struct FxRegs_s * gsu)
{
...
TESTR14; \
CLRFLAGS;
static void fx_or_r1(struct FxRegs_s * gsu) { FX_OR(1); }
static void fx_or_r2(struct FxRegs_s * gsu) { FX_OR(2); }
static void fx_or_r3(struct FxRegs_s * gsu) { FX_OR(3); }
static void fx_or_r4(struct FxRegs_s * gsu) { FX_OR(4); }
static void fx_or_r5(struct FxRegs_s * gsu) { FX_OR(5); }
static void fx_or_r6(struct FxRegs_s * gsu) { FX_OR(6); }
static void fx_or_r7(struct FxRegs_s * gsu) { FX_OR(7); }
static void fx_or_r8(struct FxRegs_s * gsu) { FX_OR(8); }
static void fx_or_r9(struct FxRegs_s * gsu) { FX_OR(9); }
static void fx_or_r10(struct FxRegs_s * gsu) { FX_OR(10); }
static void fx_or_r11(struct FxRegs_s * gsu) { FX_OR(11); }
static void fx_or_r12(struct FxRegs_s * gsu) { FX_OR(12); }
static void fx_or_r13(struct FxRegs_s * gsu) { FX_OR(13); }
static void fx_or_r14(struct FxRegs_s * gsu) { FX_OR(14); }
static void fx_or_r15(struct FxRegs_s * gsu) { FX_OR(15); }
...
TESTR14; \
CLRFLAGS;
static void fx_xor_r1(struct FxRegs_s * gsu) { FX_XOR(1); }
static void fx_xor_r2(struct FxRegs_s * gsu) { FX_XOR(2); }
static void fx_xor_r3(struct FxRegs_s * gsu) { FX_XOR(3); }
static void fx_xor_r4(struct FxRegs_s * gsu) { FX_XOR(4); }
static void fx_xor_r5(struct FxRegs_s * gsu) { FX_XOR(5); }
static void fx_xor_r6(struct FxRegs_s * gsu) { FX_XOR(6); }
static void fx_xor_r7(struct FxRegs_s * gsu) { FX_XOR(7); }
static void fx_xor_r8(struct FxRegs_s * gsu) { FX_XOR(8); }
static void fx_xor_r9(struct FxRegs_s * gsu) { FX_XOR(9); }
static void fx_xor_r10(struct FxRegs_s * gsu) { FX_XOR(10); }
static void fx_xor_r11(struct FxRegs_s * gsu) { FX_XOR(11); }
static void fx_xor_r12(struct FxRegs_s * gsu) { FX_XOR(12); }
static void fx_xor_r13(struct FxRegs_s * gsu) { FX_XOR(13); }
static void fx_xor_r14(struct FxRegs_s * gsu) { FX_XOR(14); }
static void fx_xor_r15(struct FxRegs_s * gsu) { FX_XOR(15); }
...
TESTR14; \
CLRFLAGS;
static void fx_or_i1(struct FxRegs_s * gsu) { FX_OR_I(1); }
static void fx_or_i2(struct FxRegs_s * gsu) { FX_OR_I(2); }
static void fx_or_i3(struct FxRegs_s * gsu) { FX_OR_I(3); }
static void fx_or_i4(struct FxRegs_s * gsu) { FX_OR_I(4); }
static void fx_or_i5(struct FxRegs_s * gsu) { FX_OR_I(5); }
static void fx_or_i6(struct FxRegs_s * gsu) { FX_OR_I(6); }
static void fx_or_i7(struct FxRegs_s * gsu) { FX_OR_I(7); }
static void fx_or_i8(struct FxRegs_s * gsu) { FX_OR_I(8); }
static void fx_or_i9(struct FxRegs_s * gsu) { FX_OR_I(9); }
static void fx_or_i10(struct FxRegs_s * gsu) { FX_OR_I(10); }
static void fx_or_i11(struct FxRegs_s * gsu) { FX_OR_I(11); }
static void fx_or_i12(struct FxRegs_s * gsu) { FX_OR_I(12); }
static void fx_or_i13(struct FxRegs_s * gsu) { FX_OR_I(13); }
static void fx_or_i14(struct FxRegs_s * gsu) { FX_OR_I(14); }
static void fx_or_i15(struct FxRegs_s * gsu) { FX_OR_I(15); }
...
TESTR14; \
CLRFLAGS;
static void fx_xor_i1(struct FxRegs_s * gsu) { FX_XOR_I(1); }
static void fx_xor_i2(struct FxRegs_s * gsu) { FX_XOR_I(2); }
static void fx_xor_i3(struct FxRegs_s * gsu) { FX_XOR_I(3); }
static void fx_xor_i4(struct FxRegs_s * gsu) { FX_XOR_I(4); }
static void fx_xor_i5(struct FxRegs_s * gsu) { FX_XOR_I(5); }
static void fx_xor_i6(struct FxRegs_s * gsu) { FX_XOR_I(6); }
static void fx_xor_i7(struct FxRegs_s * gsu) { FX_XOR_I(7); }
static void fx_xor_i8(struct FxRegs_s * gsu) { FX_XOR_I(8); }
static void fx_xor_i9(struct FxRegs_s * gsu) { FX_XOR_I(9); }
static void fx_xor_i10(struct FxRegs_s * gsu) { FX_XOR_I(10); }
static void fx_xor_i11(struct FxRegs_s * gsu) { FX_XOR_I(11); }
static void fx_xor_i12(struct FxRegs_s * gsu) { FX_XOR_I(12); }
static void fx_xor_i13(struct FxRegs_s * gsu) { FX_XOR_I(13); }
static void fx_xor_i14(struct FxRegs_s * gsu) { FX_XOR_I(14); }
static void fx_xor_i15(struct FxRegs_s * gsu) { FX_XOR_I(15); }
...
CLRFLAGS; R15++;
static void fx_inc_r0(struct FxRegs_s * gsu) { FX_INC(0); }
static void fx_inc_r1(struct FxRegs_s * gsu) { FX_INC(1); }
static void fx_inc_r2(struct FxRegs_s * gsu) { FX_INC(2); }
static void fx_inc_r3(struct FxRegs_s * gsu) { FX_INC(3); }
static void fx_inc_r4(struct FxRegs_s * gsu) { FX_INC(4); }
static void fx_inc_r5(struct FxRegs_s * gsu) { FX_INC(5); }
static void fx_inc_r6(struct FxRegs_s * gsu) { FX_INC(6); }
static void fx_inc_r7(struct FxRegs_s * gsu) { FX_INC(7); }
static void fx_inc_r8(struct FxRegs_s * gsu) { FX_INC(8); }
static void fx_inc_r9(struct FxRegs_s * gsu) { FX_INC(9); }
static void fx_inc_r10(struct FxRegs_s * gsu) { FX_INC(10); }
static void fx_inc_r11(struct FxRegs_s * gsu) { FX_INC(11); }
static void fx_inc_r12(struct FxRegs_s * gsu) { FX_INC(12); }
static void fx_inc_r13(struct FxRegs_s * gsu) { FX_INC(13); }
static void fx_inc_r14(struct FxRegs_s * gsu) { FX_INC(14); READR14; }

/* df - getc - transfer ROM buffer to color register */
static void fx_getc(struct FxRegs_s * gsu)
{
...
static void fx_ramb(struct FxRegs_s * gsu)
{
...
static void fx_romb(struct FxRegs_s * gsu)
{
...
gsu->vZero = gsu->avReg[reg]; \
CLRFLAGS; R15++;
static void fx_dec_r0(struct FxRegs_s * gsu) { FX_DEC(0); }
static void fx_dec_r1(struct FxRegs_s * gsu) { FX_DEC(1); }
static void fx_dec_r2(struct FxRegs_s * gsu) { FX_DEC(2); }
static void fx_dec_r3(struct FxRegs_s * gsu) { FX_DEC(3); }
static void fx_dec_r4(struct FxRegs_s * gsu) { FX_DEC(4); }
static void fx_dec_r5(struct FxRegs_s * gsu) { FX_DEC(5); }
static void fx_dec_r6(struct FxRegs_s * gsu) { FX_DEC(6); }
static void fx_dec_r7(struct FxRegs_s * gsu) { FX_DEC(7); }
static void fx_dec_r8(struct FxRegs_s * gsu) { FX_DEC(8); }
static void fx_dec_r9(struct FxRegs_s * gsu) { FX_DEC(9); }
static void fx_dec_r10(struct FxRegs_s * gsu) { FX_DEC(10); }
static void fx_dec_r11(struct FxRegs_s * gsu) { FX_DEC(11); }
static void fx_dec_r12(struct FxRegs_s * gsu) { FX_DEC(12); }
static void fx_dec_r13(struct FxRegs_s * gsu) { FX_DEC(13); }
static void fx_dec_r14(struct FxRegs_s * gsu) { FX_DEC(14); READR14; }

/* ef - getb - get byte from ROM at address R14 */
static void fx_getb(struct FxRegs_s * gsu)
{
    uint32 v;
#ifndef FX_DO_ROMBUFFER
    v = (uint32)ROM(R14);
...
static void fx_getbh(struct FxRegs_s * gsu)
{
    uint32 v;
#ifndef FX_DO_ROMBUFFER
    uint32 c;
...
static void fx_getbl(struct FxRegs_s * gsu)
{
    uint32 v;
#ifndef FX_DO_ROMBUFFER
    uint32 c;
...
static void fx_getbs(struct FxRegs_s * gsu)
{
    uint32 v;
#ifndef FX_DO_ROMBUFFER
    int8 c;
...
gsu->avReg[reg] = v; \
CLRFLAGS;
static void fx_iwt_r0(struct FxRegs_s * gsu) { FX_IWT(0); }
static void fx_iwt_r1(struct FxRegs_s * gsu) { FX_IWT(1); }
static void fx_iwt_r2(struct FxRegs_s * gsu) { FX_IWT(2); }
static void fx_iwt_r3(struct FxRegs_s * gsu) { FX_IWT(3); }
static void fx_iwt_r4(struct FxRegs_s * gsu) { FX_IWT(4); }
static void fx_iwt_r5(struct FxRegs_s * gsu) { FX_IWT(5); }
static void fx_iwt_r6(struct FxRegs_s * gsu) { FX_IWT(6); }
static void fx_iwt_r7(struct FxRegs_s * gsu) { FX_IWT(7); }
static void fx_iwt_r8(struct FxRegs_s * gsu) { FX_IWT(8); }
static void fx_iwt_r9(struct FxRegs_s * gsu) { FX_IWT(9); }
static void fx_iwt_r10(struct FxRegs_s * gsu) { FX_IWT(10); }
static void fx_iwt_r11(struct FxRegs_s * gsu) { FX_IWT(11); }
static void fx_iwt_r12(struct FxRegs_s * gsu) { FX_IWT(12); }
static void fx_iwt_r13(struct FxRegs_s * gsu) { FX_IWT(13); }
static void fx_iwt_r14(struct FxRegs_s * gsu) { FX_IWT(14); READR14; }
static void fx_iwt_r15(struct FxRegs_s * gsu) { FX_IWT(15); }
...
CLRFLAGS;
static void fx_lm_r0(struct FxRegs_s * gsu) { FX_LM(0); }
static void fx_lm_r1(struct FxRegs_s * gsu) { FX_LM(1); }
static void fx_lm_r2(struct FxRegs_s * gsu) { FX_LM(2); }
static void fx_lm_r3(struct FxRegs_s * gsu) { FX_LM(3); }
static void fx_lm_r4(struct FxRegs_s * gsu) { FX_LM(4); }
static void fx_lm_r5(struct FxRegs_s * gsu) { FX_LM(5); }
static void fx_lm_r6(struct FxRegs_s * gsu) { FX_LM(6); }
static void fx_lm_r7(struct FxRegs_s * gsu) { FX_LM(7); }
static void fx_lm_r8(struct FxRegs_s * gsu) { FX_LM(8); }
static void fx_lm_r9(struct FxRegs_s * gsu) { FX_LM(9); }
static void fx_lm_r10(struct FxRegs_s * gsu) { FX_LM(10); }
static void fx_lm_r11(struct FxRegs_s * gsu) { FX_LM(11); }
static void fx_lm_r12(struct FxRegs_s * gsu) { FX_LM(12); }
static void fx_lm_r13(struct FxRegs_s * gsu) { FX_LM(13); }
static void fx_lm_r14(struct FxRegs_s * gsu) { FX_LM(14); READR14; }
static void fx_lm_r15(struct FxRegs_s * gsu) { FX_LM(15); }
...
RAM(gsu->vLastRamAdr^1) = (uint8)(v>>8); \
CLRFLAGS; R15++;
static void fx_sm_r0(struct FxRegs_s * gsu) { FX_SM(0); }
static void fx_sm_r1(struct FxRegs_s * gsu) { FX_SM(1); }
static void fx_sm_r2(struct FxRegs_s * gsu) { FX_SM(2); }
static void fx_sm_r3(struct FxRegs_s * gsu) { FX_SM(3); }
static void fx_sm_r4(struct FxRegs_s * gsu) { FX_SM(4); }
static void fx_sm_r5(struct FxRegs_s * gsu) { FX_SM(5); }
static void fx_sm_r6(struct FxRegs_s * gsu) { FX_SM(6); }
static void fx_sm_r7(struct FxRegs_s * gsu) { FX_SM(7); }
static void fx_sm_r8(struct FxRegs_s * gsu) { FX_SM(8); }
static void fx_sm_r9(struct FxRegs_s * gsu) { FX_SM(9); }
static void fx_sm_r10(struct FxRegs_s * gsu) { FX_SM(10); }
static void fx_sm_r11(struct FxRegs_s * gsu) { FX_SM(11); }
static void fx_sm_r12(struct FxRegs_s * gsu) { FX_SM(12); }
static void fx_sm_r13(struct FxRegs_s * gsu) { FX_SM(13); }
static void fx_sm_r14(struct FxRegs_s * gsu) { FX_SM(14); }
static void fx_sm_r15(struct FxRegs_s * gsu) { FX_SM(15); }

/*** GSU executions functions ***/

static uint32 fx_run(uint32 nInstructions, struct FxRegs_s * gsu)
{
...
static uint32 fx_run_to_breakpoint(uint32 nInstructions, struct FxRegs_s * gsu)
{
    uint32 vCounter = 0;
...
static uint32 fx_step_over(uint32 nInstructions, struct FxRegs_s * gsu)
{
    uint32 vCounter = 0;
    while(TF(G) && vCounter < nInstructions)
    {
...
uint32 (*FX_FUNCTION_TABLE[])(uint32, struct FxRegs_s * gsu) =
#else
uint32 (*fx_apfFunctionTable[])(uint32, struct FxRegs_s * gsu) =
#endif
{
    &fx_run,
...
#ifdef FX_PLOT_TABLE
void (*FX_PLOT_TABLE[])(struct FxRegs_s * gsu) =
#else
void (*fx_apfPlotTable[])(struct FxRegs_s * gsu) =
#endif
{
...
void (*FX_OPCODE_TABLE[])(struct FxRegs_s *) =
#else
void (*fx_apfOpcodeTable[])(struct FxRegs_s *) =
#endif
{
    /*
     * ALT0 Table
