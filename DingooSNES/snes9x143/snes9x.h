...
#define STREAM FILE *
#define READ_STREAM(p,l,s)    ips_fread (p,1,l,s)
#define WRITE_STREAM(p,l,s)   fwrite (p,1,l,s)
#define OPEN_STREAM(f,m)      ips_fopen (f,m)
#define REOPEN_STREAM(f,m)    fdopen (f,m)
#define FIND_STREAM(f)        ftell(f)
#define REVERT_STREAM(f,o,s)  ips_fseek(f,o,s)
#define CLOSE_STREAM(s)       ips_fclose (s)
#else
#define STREAM FILE *
