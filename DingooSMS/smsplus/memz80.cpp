...
/*--------------------------------------------------------------------------*/
void sms_port_w(uint8 port, uint8 data)
{
    port &= 0xFF;
...
void gg_port_w(uint8 port, uint8 data)
{
    port &= 0xFF;
...
void ggms_port_w(uint8 port, uint8 data)
{
    port &= 0xFF;
...
void tms_port_w(uint8 port, uint8 data)
{
    switch(port & 0xC0)
    {
        case 0x40:
...
/*--------------------------------------------------------------------------*/
void coleco_port_w(uint8 port, uint8 data)
{
...
uint8 coleco_port_r(uint8 port)
{
    /* A7 is used as enable input */
    /* A6 & A5 are used to decode the address */
    switch(port & 0xE0)
