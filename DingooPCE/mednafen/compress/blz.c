...
#ifndef _DINGOO
#if BLZ_PPC || defined (__m68k__) || defined (__i386__) || defined (__x86_64__) || defined (_M_IX86) || defined (_M_X64)
	#ifndef BLZ_FAST
		#define BLZ_FAST 1
	#endif
	#ifndef BLZ_FAST_CLZ
...
#ifndef GET16
	#define GET16( addr )       (*(uint16a const*) (addr))
	#define GET32( addr )       (*(uint32a const*) (addr))
	#define GET32S( addr )      (*( int32a const*) (addr))
	#define SET16( addr, in )   (void) (*(uint16a*) (addr) = (uint16_t) (in))
	#define SET32( addr, in )   (void) (*(uint32a*) (addr) = (uint32_t) (in))
#endif
