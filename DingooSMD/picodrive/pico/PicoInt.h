...
// ----------------------- 68000 CPU -----------------------
#ifdef EMU_C68K
#include "cpu_m68k/Cyclone/Cyclone.h"
...
#define SekCyclesLeft \
	(((PicoMCD&1) && (PicoOpt & PicoOpt_cd_perfect_sync)) ? (SekCycleAim-SekCycleCnt) : SekCyclesLeftNoMCD)
#define SekCyclesLeftS68k \
	((PicoOpt & PicoOpt_cd_perfect_sync) ? (SekCycleAimS68k-SekCycleCntS68k) : PicoCpuCS68k.cycles)
#define SekSetCyclesLeftNoMCD(c) PicoCpuCM68k.cycles=c
#define SekSetCyclesLeft(c) { \
	if ((PicoMCD&1) && (PicoOpt & PicoOpt_cd_perfect_sync)) SekCycleCnt=SekCycleAim-(c); else SekSetCyclesLeftNoMCD(c); \
}
...
#ifdef EMU_F68K
#include "cpu_m68k/fame/fame.h"
extern M68K_CONTEXT PicoCpuFM68k, PicoCpuFS68k;
#define SekCyclesLeftNoMCD PicoCpuFM68k.io_cycle_counter
#define SekCyclesLeft \
	(((PicoMCD&1) && (PicoOpt & PicoOpt_cd_perfect_sync)) ? (SekCycleAim-SekCycleCnt) : SekCyclesLeftNoMCD)
#define SekCyclesLeftS68k \
	((PicoOpt & PicoOpt_cd_perfect_sync) ? (SekCycleAimS68k-SekCycleCntS68k) : PicoCpuFS68k.io_cycle_counter)
...
#ifdef EMU_M68K
#include "cpu_m68k/musashi/m68kcpu.h"
...
#define SekCyclesLeft \
	(((PicoMCD&1) && (PicoOpt & PicoOpt_cd_perfect_sync)) ? (SekCycleAim-SekCycleCnt) : SekCyclesLeftNoMCD)
#define SekCyclesLeftS68k \
	((PicoOpt & PicoOpt_cd_perfect_sync) ? (SekCycleAimS68k-SekCycleCntS68k) : PicoCpuMS68k.cyc_remaining_cycles)
#define SekSetCyclesLeftNoMCD(c) SET_CYCLES(c)
#define SekSetCyclesLeft(c) { \
	if ((PicoMCD&1) && (PicoOpt & PicoOpt_cd_perfect_sync)) SekCycleCnt=SekCycleAim-(c); else SET_CYCLES(c); \
}
