...
u32 OtherRead16(u32 a, int realsize)
{
  ...
  if ((a&0xff0000)==0xa00000) {
    ...
    if ((a&0x6000)==0x4000) { // 0x4000-0x5fff, Fudge if disabled
      if(PicoOpt & PicoOpt_enable_ym2612_dac) d=YM2612Read();
...
static void IoWrite8(u32 a, u32 d)
{
  ...
  if(PicoOpt & PicoOpt_6button_gamepad) {
    if(a==1) {
      Pico.m.padDelay[0] = 0;
...
void OtherWrite8(u32 a,u32 d)
{
  ...
  if ((a&0xe700f9)==0xc00011||(a&0xff7ff9)==0xa07f11) { if(PicoOpt & PicoOpt_enable_sn76496) SN76496Write(d); return; } // PSG Sound
  if ((a&0xff4000)==0xa00000)  { if(!(Pico.m.z80Run&1)) Pico.zram[a&0x1fff]=(u8)d; return; } // Z80 ram
  if ((a&0xff6000)==0xa04000)  { if(PicoOpt & PicoOpt_enable_ym2612_dac) emustatus|=YM2612Write(a&3, d)&1; return; } // FM Sound
...
void OtherWrite16(u32 a,u32 d)
{
  ...
  if ((a&0xe700f8)==0xc00010||(a&0xff7ff8)==0xa07f10) { if(PicoOpt & PicoOpt_enable_sn76496) SN76496Write(d); return; } // PSG Sound
  if ((a&0xff6000)==0xa04000)  { if(PicoOpt & PicoOpt_enable_ym2612_dac) emustatus|=YM2612Write(a&3, d)&1; return; } // FM Sound (??)
  if ((a&0xff7f00)==0xa06000) // Z80 BANK register
  {
    Pico.m.z80_bank68k>>=1;
