...
struct DrMD
{
  ...
  void (*palette_set)(unsigned int index, unsigned int color);   // 0x4C
...
extern void DrMDUpdateMDPal(void);
extern void m68k_irq_callback(int);
...
extern unsigned char DrMD_Z80_In(unsigned short p);
extern void DrMD_Z80_Out(unsigned short p,unsigned char d);
